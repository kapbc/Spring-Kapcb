...
public class RedisService {
     ...
     * @return Long
     */
    public Long removeListForCounts(String key, Long count, Object value) {
        try {
            return redisTemplate.opsForList().remove(key, count, value);
        } catch (Exception e) {
            log.error("remove list for counts value error, the exception is : " + e.getMessage());
            return 0L;
        }
    }
}
